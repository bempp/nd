//! Topology for meshes where entities of each tdim are the same type
...
/// Topology of a single element mesh
#[derive(Debug)]
...
impl SingleTypeTopology {
    ...
    pub fn new(
        ...
        // Hence, downward_connectivity[2][1][0, 5] for a triangle mesh gives the index of the
...
mod test {
    ...
    fn test_sub_entities_tetrahedron() {
        ...
        assert_eq!(cell1.sub_entity(ReferenceCellType::Interval, 0), 6);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Interval, 1), 7);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Interval, 2), 8);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Interval, 3), 1);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Interval, 4), 2);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Interval, 5), 5);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Triangle, 0), 4);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Triangle, 1), 5);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Triangle, 2), 6);
        assert_eq!(cell1.sub_entity(ReferenceCellType::Triangle, 3), 2);
        ...
        assert_eq!(face0.sub_entity(ReferenceCellType::Point, 0), 0);
        assert_eq!(face0.sub_entity(ReferenceCellType::Point, 1), 1);
        assert_eq!(face0.sub_entity(ReferenceCellType::Point, 2), 2);
        assert_eq!(face0.sub_entity(ReferenceCellType::Interval, 0), 0);
        assert_eq!(face0.sub_entity(ReferenceCellType::Interval, 1), 1);
        assert_eq!(face0.sub_entity(ReferenceCellType::Interval, 2), 3);
        ...
        assert_eq!(face1.sub_entity(ReferenceCellType::Point, 1), 1);
        assert_eq!(face1.sub_entity(ReferenceCellType::Point, 2), 3);
        assert_eq!(face1.sub_entity(ReferenceCellType::Interval, 0), 0);
        assert_eq!(face1.sub_entity(ReferenceCellType::Interval, 1), 2);
        ...
        assert_eq!(face2.sub_entity(ReferenceCellType::Point, 1), 2);
        assert_eq!(face2.sub_entity(ReferenceCellType::Point, 2), 3);
        assert_eq!(face2.sub_entity(ReferenceCellType::Interval, 0), 1);
        assert_eq!(face2.sub_entity(ReferenceCellType::Interval, 1), 2);
        ...
        assert_eq!(face3.sub_entity(ReferenceCellType::Point, 0), 1);
        assert_eq!(face3.sub_entity(ReferenceCellType::Point, 1), 2);
        assert_eq!(face3.sub_entity(ReferenceCellType::Point, 2), 3);
        assert_eq!(face3.sub_entity(ReferenceCellType::Interval, 0), 3);
        ...
        assert_eq!(face4.sub_entity(ReferenceCellType::Point, 0), 0);
        assert_eq!(face4.sub_entity(ReferenceCellType::Point, 1), 2);
        assert_eq!(face4.sub_entity(ReferenceCellType::Point, 2), 4);
        assert_eq!(face4.sub_entity(ReferenceCellType::Interval, 0), 6);
        assert_eq!(face4.sub_entity(ReferenceCellType::Interval, 1), 7);
        assert_eq!(face4.sub_entity(ReferenceCellType::Interval, 2), 1);
        ...
        assert_eq!(face5.sub_entity(ReferenceCellType::Interval, 0), 6);
        assert_eq!(face5.sub_entity(ReferenceCellType::Interval, 1), 8);
        assert_eq!(face5.sub_entity(ReferenceCellType::Interval, 2), 2);
        ...
        assert_eq!(face6.sub_entity(ReferenceCellType::Point, 0), 2);
        assert_eq!(face6.sub_entity(ReferenceCellType::Point, 1), 3);
        assert_eq!(face6.sub_entity(ReferenceCellType::Point, 2), 4);
        assert_eq!(face6.sub_entity(ReferenceCellType::Interval, 0), 7);
        assert_eq!(face6.sub_entity(ReferenceCellType::Interval, 1), 8);
        assert_eq!(face6.sub_entity(ReferenceCellType::Interval, 2), 5);
        ...
        assert_eq!(edge3.sub_entity(ReferenceCellType::Point, 1), 2);
        assert_eq!(edge3.sub_entity(ReferenceCellType::Interval, 0), 3);
        let edge4 = SingleTypeEntityTopology::new(&t, ReferenceCellType::Interval, 4);
        assert_eq!(edge4.sub_entity(ReferenceCellType::Point, 0), 1);
        assert_eq!(edge4.sub_entity(ReferenceCellType::Point, 1), 3);
        ...
        assert_eq!(edge5.sub_entity(ReferenceCellType::Point, 0), 2);
        assert_eq!(edge5.sub_entity(ReferenceCellType::Point, 1), 3);
        ...
        assert_eq!(edge6.sub_entity(ReferenceCellType::Point, 0), 0);
        ...
        assert_eq!(edge8.sub_entity(ReferenceCellType::Point, 0), 3);
