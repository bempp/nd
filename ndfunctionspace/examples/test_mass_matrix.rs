...
use ndgrid::{
    ...
    traits::{Grid, Entity, GeometryMap},
};
use quadraturerules::{single_integral_quadrature, QuadratureRule, Domain};
...
fn test_lagrange_mass_matrix() {
    ...
    let gmap = grid
        .geometry_map(ReferenceCellType::Triangle, 1, pts.data().unwrap());
